            ...
            key={item.news_id}>
              <div className='grid grid-cols-3 mb-6 mx-3'>
                <div className='col-span-1'>
                  <Image aria-label='news related image' width={300} height={250} className='object-cover' src={item.image_path} alt="news Image" />
                </div>
            ...
            key={item.news_id}>
              <div className='grid grid-cols-8 mb-2'>
                ...
                <div className='col-span-3 ms-1'>
                  <Image aria-label='news related image' src={item.image_path} alt="news image" width={150} height={150} />
                </div>
              </div>
              </Link>
            )}
