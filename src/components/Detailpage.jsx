      ...
      <div className='max-w-7xl mx-auto'>
        <div className='grid lg:grid-cols-7 px-6 md:mx-6'>
          <div className='lg:col-span-5'>
            ...
            {newsApiData.map((item) =>
              <Image aria-label='news related image' key={item.news_id} width={300} height={300} className='w-full h-auto mx-auto object-cover' src={item.image_path} alt="news image" />
            )}
                      ...
                      {apiData.slice(5, 9).map((item) =>
                        <div key={item.news_id} className='grid grid-cols-6'>
                          ...
                          <div className='col-span-2 ms-1'>
                            <Image aria-label='news related image' src={item.image_path} alt="news image" width={65} height={65} className='w-full' />
                          </div>
                        </div>
                      )}
          ...
          <div className=' lg:col-span-2  ms-2'>
            <div>
              ...
              <Image width={300} height={300} className=' h-auto mb-2 mx-auto ps-1 w-auto' src={vansad} alt="ad image " />
            </div>
